...
BLEService accService("180A");  // BLE Sensor Service

// BLE LED Switch Characteristic - custom 128-bit UUID, read and writable by central
BLEIntCharacteristic switchCharacteristic("2A57", BLENotify | BLEWrite);
...
void setup() {
  ...
  accService.addCharacteristic(switchCharacteristic);
  ...
  if (central) {
    ...
    while (central.connected()) {
      ...
      if (IMU.accelerationAvailable()) {
        ...
        // variable.
        //Lot of the below can be commented out - won't be connected to anything that can show the Serial print statements.
        Serial.print(x);
        Serial.print("/");
        Serial.print(y);
        Serial.print("/");
        ...
        delay(250);
        switchCharacteristic.writeValue(dailySteps);
        switchCharacteristic.writeValue(body.heartRate);
        switchCharacteristic.writeValue(body.oxygen);
      }
